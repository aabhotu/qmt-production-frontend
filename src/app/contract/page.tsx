  ...
  const contactItems = [
    {
      ...
      title: 'Trụ sở chính',
      content: 'Số nhà 20A, Tổ 8, Phường Chùa Hang, TP Thái Nguyên, Tỉnh Thái Nguyên',
    },
    {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6">
        ...
        {/* Map */}
        <div ref={mapRef} className="rounded-xl overflow-hidden shadow-lg mb-16">
          <iframe
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {contactItems.map((item, i) => (
            ...
            >
              ...
              <h5 className="font-medium text-lg text-[#00B207] uppercase mb-2">{item.title}</h5>

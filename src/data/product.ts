...
export const products: IProduct[] = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        contents: [
          {
            content: "Trộn vữa với tỉ lệ bao 25kg với 8–10 lít nước sạch.",
          },
          {
            content:
    ...
    imageSrc: "/images/vua_xoa_tuong_v01-1.png",
    width: 200,
    highlight: true,
  },
  {
    name: "Vữa xoa tường V02",
    briefInfo: "HƯỚNG DẪN SỬ DỤNG VỮA XOA TƯỜNG VIKKO V02",
    conclusionInfo: {
      title: "KẾT QUẢ KỲ VỌNG SAU KHI THI CÔNG",
      contents: [
        {
    ...
    imageSrc: "/images/vua_xoa_tuong-1.png",
    width: 200,
    highlight: true,
  },
  {
    ...
    imageSrc: "/images/keo_dan_gach-1.png",
    width: 200,
    highlight: false,
  },
  {
    ...
    briefInfo: "GIỚI THIỆU SẢN PHẨM",
    description:
      "Sơn Vikko là dòng sơn nước cao cấp, được sản xuất từ nguyên liệu chất lượng cao, với công nghệ tiên tiến, mang lại độ bền màu, chống thấm và bảo vệ tối ưu cho bề mặt tường. Hiện tại, Vikko đang sản xuất và cung cấp các loại sơn như sau:",
    features: [
      {
        title: "Vikko Exterior High Gloss",
        contents: [
          {
  ...
  },
  {
    ...
    briefInfo: "GIỚI THIỆU SẢN PHẨM",
    description:
      "Phụ gia xây dựng VIKKO là dòng sản phầm chuyên dụng, được nghiên cứu và phát triển nhằm tăng cường độ bền, khả năng chống thấm, độ kết dính và khả năng thi công của vữa, bê tông trong các công trình xây dựng dân dụng và công nghiệp.",
    features: [
      {
        title: "Công dụng chính",
        contents: [
          {
            content: "Tăng độ bám dính cho vữa và bê tông.",
          },
          {
            content:
              "Cải thiện khả năng chống thấm nước cho các kết cấu xi măng.",
          },
          {
            content: "Tăng độ linh hoạt và dẻo trong quá trình thi công.",
          },
          {
            content: "Giảm hiện tượng nứt, co ngót, tăng tuổi thọ công trình.",
          },
          {
            content: "Tăng khả năng chịu lực và độ bền cơ học của bê tông.",
          },
        ],
      },
      {
        ...
        contents: [
          {
            content: "Dùng cho vữa trát, xây, bê tông sàn, bê tông chống thấm.",
          },
          {
            content:
              "Thích hợp cho các hạng mục như: bể nước, nhà vệ sinh, tầng hầm, mái bê tông, ban công",
          },
          {
            content:
              "Có thể sử dụng cho cả công trình mới xây dựng và sửa chữa, cải tạo",
          },
        ],
      },
      {
        ...
        contents: [
          {
            content:
              "Dễ sử dụng, hòa trộn trực tiếp vào nước trộn vữa/bê tông.",
          },
          {
            content: "Tương thích với nhiều loại xi măng, cát",
          },
          {
            content:
              "Thân thiện với môi trường, không độc hại, không ăn mòn thép",
          },
          {
            content: "Hiệu quả cao ngay cả trong điều kiện khí hậu khắc nghiệt",
          },
        ],
      },
      {
        ...
        contents: [
          {
            content: "Trộn phụ gia Vikko với nước theo tỷ lệ khuyến nghị.",
          },
          {
            content: "Hòa vào hỗn hợp xi măng, cát, đá để trộn đều.",
          },
          {
            content:
              "Lượng dùng thông thường: 0.5 – 1.5% khối lượng xi măng, tùy theo yêu cầu kỹ thuật và điều kiện thực tế.",
          },
          {
            content: "Có thể dùng cho máy trộn hoặc trộn tay đều được.",
          },
          {
            content: "Lưu ý: Tuân thủ đúng liều lượng để đạt hiệu quả tối ưu.",
          },
        ],
      },
      {
        ...
        contents: [
          {
            content:
              "Hộp nhựa 4kg – phù hợp cho nhu cầu sửa chữa nhỏ, thi công diện tích nhỏ.",
          },
          {
            content:
              "Bao 10kg – dùng cho công trình vừa, tiện lợi và linh hoạt.",
          },
          {
            content:
              "Bao 20kg – phù hợp cho công trình lớn, tiết kiệm chi phí thi công.",
          },
        ],
      },
    ],
